...
function SidebarMenuButton({
  ...
  // When tooltip is set without a custom render, use TooltipTrigger as the element.
  // When tooltip and render are both set, use render (e.g. Link) so the link works and wrap it with TooltipTrigger asChild.
  const renderElement =
    tooltip && render ? render : !tooltip ? render : TooltipTrigger
