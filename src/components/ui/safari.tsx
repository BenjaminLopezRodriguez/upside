...
export function Safari({
  ...
  const hasCustomContent = !!children && !hasMedia
  ...
  return (
    ...
    >
      ...
      {hasCustomContent && (
        <div
          className="absolute z-0 overflow-auto rounded-b-[11px] bg-background"
          style={{
            left: `${LEFT_PCT}%`,
            top: `${TOP_PCT}%`,
            width: `${WIDTH_PCT}%`,
      ...
      >
        ...
        <g
          clipPath="url(#path0)"
          mask={hasMedia || hasCustomContent ? "url(#safariPunch)" : undefined}
        >
          <path
